                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        ...
                                                        <button type="button" class="btn btn-sm" style="background-color: none; outline:none" data-bs-toggle="modal" data-bs-target="#delete{{$category['id']}}">
                                                            <em class="icon ni ni-trash text-danger" title="حذف" style="font-size:25px ; cursor:pointer"></em>
                                                        </button>
                                                </td>
                                            </tr>
                                            <!-- Delete Modal -->
                                            <div class="modal fade" id="delete{{$category['id']}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body modal-body modal-body-lg text-center">
                                                            <div class="nk-modal">
                                                                    <em class="nk-modal-icon icon icon-circle icon-circle-xxl ni ni-cross bg-danger"></em>
                                                                    <h5 class="nk-modal-title">حذف  التصنيف !</h5>
                                                                    <div class="nk-modal-text">
                                                                        <p class="lead"> هل أنت متأكد من حذف التصنيف ؟!</p>
                                                                    </div>
                                                                    <form action="{{url('admin/categories/'.$category['id'].'/delete')}}"method="Get">
                                                                        @csrf
                                                                        <input type="text" value="{{$category['category_name']}}" class="mb-5 text-center" disabled>
                                                                        <div>
