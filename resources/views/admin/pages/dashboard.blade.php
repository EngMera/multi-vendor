                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h4 class="nk-block-title page-title">الرئيسية</h4>
                                        ...
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h6 class="title">إجمالي المبيعات</h6>
                                                </div>
                                                <div class="card-tools">
                                                    <a href="#" class="link">عرض التقرير</a>
                                                </div>
                                            </div>
                                            <div class="data">
                                                <div class="amount">$74,958.49</div>
                                                <div class="info"><strong>$7,395.37</strong> في الشهر الماضي</div>
                                            </div>
                                            <div class="data">
                                                <h6 class="sub-title">هذا الأسبوع حتى الآن</h6>
                                                <div class="data-group">
                                                    <div class="amount">$1,338.72</div>
                                                    <div class="info text-end"><span class="change up text-danger"><em class="icon ni ni-arrow-long-up"></em>4.63%</span><br><span>مقابل الأسبوع الماضي</span></div>
                                                </div>
                                            </div>
                                        </div><!-- .card-inner -->
                                        <div class="nk-ecwg1-ck">
                                            <canvas class="ecommerce-line-chart-s1 chartjs-render-monitor" id="totalSales" style="display: block; width: 487px; height: 110px;" width="487" height="110"></canvas>
                                        </div>
                                    </div><!-- .nk-ecwg -->
                                </div><!-- .card -->
                            </div><!-- .col -->
                                ...
                                <div class="card h-100">
                                    <div class="nk-ecwg nk-ecwg2">
                                        <div class="card-inner">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                <li><a href="#"><span>3 اشهر</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <h6 class="sub-title">الطلبات بمرور الوقت</h6>
                                        </div><!-- .card-inner -->
                            ...
                            <div class="col-xxl-8">
                                <div class="card card-full">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">الطلبيات الأخيرة</h6>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card h-100">
                                    <div class="card-inner">
                                        ...
                                        <ul class="nk-top-products">
                                            <li class="item">
                                                <div class="thumb">
                                                    <img src="{{asset('assets/admin/images/product/a.png')}}" alt="">
                                                </div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="thumb">
                                                    <img src="{{asset('assets/admin/images/product/b.png')}}" alt="">
                                                </div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="thumb">
                                                    <img src="{{asset('assets/admin/images/product/c.png')}}" alt="">
                                                </div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="thumb">
                                                    <img src="{{asset('assets/admin/images/product/d.png')}}" alt="">
                                                </div>
                                                <div class="info">
                                            ...
                                            <li class="item">
                                                <div class="thumb">
                                                    <img src="{{asset('assets/admin/images/product/e.png')}}" alt="">
                                                </div>
                                                <div class="info">
