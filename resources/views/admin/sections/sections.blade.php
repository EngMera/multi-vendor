                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <a href="javascript:void(0)" id="section-{{$section['id']}}"
                                                    section_id = {{ $section['id'] }} class="updateSectionStatus">
                                                ...
                                                <td>
                                                        ...
                                                        <button type="button" class="btn btn-sm" style="background-color: none; outline:none" data-bs-toggle="modal" data-bs-target="#delete{{$section['id']}}">
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body modal-body modal-body-lg text-center">
                                                            <div class="nk-modal">
                                                                    ...
                                                                    <h5 class="nk-modal-title">حذف  القسم !</h5>
                                                                    <div class="nk-modal-text">
                                                                        <p class="lead"> هل أنت متأكد من حذف القسم ؟!</p>
                                                                    </div>
                                                                    <form action="{{url('admin/sections/'.$section['id'].'/delete')}}"method="Get">
                                                                        @csrf
                                                                        <input type="text" value="{{$section['name']}}" class="mb-5 text-center" disabled>
                                                                        <div>
