                                ...
                                <div class="row g-gs">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" id="shop_name" name="shop_name"  value="{{$vendorBusiness->shop_name}}" placeholder="ادخل اسم المتجر" value="" aria-invalid="false"required >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" id="shop_address" name="shop_address" value="{{$vendorBusiness->shop_address}}" placeholder="ادخل العنوان "  value="" aria-invalid="false"required >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label" for="business_licence_number">رقم الرخصة التجارية </label>
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control form-control-lg" id="business_licence_number" name="business_licence_number" placeholder="ادخل رقم الرخصة التجارية  "   value="{{$vendorBusiness->business_license_number}}" aria-invalid="false"required >
                                                @error('business_licence_number')<div class="alert alert-danger">{{ $message }}</div>@enderror
                                            </div>
                                        </div>
                                    </div>
