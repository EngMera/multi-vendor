                    ...
                    <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                        <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                            <div class="quick-icon border border-light">
                                <img class="icon" src="{{asset('assets/admin/images/flags/saudi.png')}}" alt="">
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                            <ul class="language-list">
                                <li>
                                    <a href="{{url('dashboard')}}" class="language-item">
                                        <img src="{{asset('assets/admin/images/flags/saudi.png')}}" alt="" class="language-flag">
                                        <span class="language-name">عربي</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="{{asset('assets/admin/images/flags/english.png')}}" alt="" class="language-flag">
