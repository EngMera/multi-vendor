    ...
    <div class="nk-sidebar-element nk-sidebar-head">
        <div class="nk-sidebar-brand">
            <a href="/dashboard" class="logo-link nk-sidebar-logo">
                ...
                <img class="logo-small logo-img logo-img-small" src="{{asset('assets/admin/images/logo-small.png')}}" srcset="{{asset('assets/admin/images/logo-small2x.png ')}} 2x" alt="logo-small">
            </a>
        </div>
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-heading">
                        <h6 class="overline-title text-primary-alt">لوحة التحكم</h6>
                    </li>
                    <!-- لوحة التحكم -->
