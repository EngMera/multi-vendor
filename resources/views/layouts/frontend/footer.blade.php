                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="{{url('assets/frontend/images/logos/footer-logo.png')}}" class="footer-logo1" alt="Images">
                                <img src="{{url('assets/frontend/images/logos/logo-1.png')}}" class="footer-logo2" alt="Images">
                            </a>
                        </div>
                        <p>
